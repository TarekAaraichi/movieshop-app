    ...
    <section className="py-8">
      ...
      <div className="relative group">
        <div
          ...
          role="list"
          className="flex gap-4 md:gap-6 overflow-x-auto pb-2 px-1 snap-x snap-mandatory focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 rounded-lg hide-scrollbar"
        >
          {movies.map((movie) => (
            <div
              key={movie.id}
