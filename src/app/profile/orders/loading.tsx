  ...
  <div className="bg-white dark:bg-neutral-800/50 border border-neutral-200 dark:border-neutral-800 rounded-lg overflow-hidden shadow-md animate-pulse">
    <div className="p-4 border-b border-neutral-200 dark:border-neutral-800 flex justify-between items-center">
      ...
      <div className="text-right">
        ...
        <div className="h-5 w-16 bg-gray-200 dark:bg-gray-700 rounded mt-2"></div>
      </div>
    </div>
    <div className="p-4">
      <ul className="space-y-4">
        {[...Array(2)].map((_, i) => (
          <li key={i} className="flex items-center gap-4">
            <div className="w-10 h-14 bg-gray-200 dark:bg-gray-700 rounded-md"></div>
            <div className="flex-1">
              <div className="h-5 w-3/4 bg-gray-200 dark:bg-gray-700 rounded"></div>
              <div className="h-4 w-1/4 bg-gray-200 dark:bg-gray-700 rounded mt-2"></div>
            </div>
            <div className="h-5 w-16 bg-gray-200 dark:bg-gray-700 rounded"></div>
            <div className="h-4 w-10 bg-gray-200 dark:bg-gray-700 rounded ml-2"></div>
          </li>
        ))}
      </ul>
    </div>
    ...
    <PageWrapper>
      <div className="max-w-4xl mx-auto">
        <header className="mb-8">
          <div className="h-10 w-1/2 bg-gray-300 dark:bg-gray-700 rounded-lg animate-pulse"></div>
          <div className="h-4 w-1/3 bg-gray-200 dark:bg-gray-600 rounded mt-3 animate-pulse"></div>
        </header>
