    ...
    <PageWrapper>
      <div className="w-full mx-auto flex items-start gap-2 p-1 rounded-2xl">
        <aside className="shrink-0 p-2">
          <div className="w-64 h-64 rounded-full bg-neutral-800 animate-pulse"></div>
        ...
        <main className="w-full mx-auto grow p-2">
          <section className="flex flex-col gap-6 items-start p-5 rounded-[14px] bg-neutral-900/80 border border-neutral-700">
            <div className="flex-1 min-w-0">
              <div className="h-9 w-1/2 rounded-lg bg-neutral-700 animate-pulse"></div>
            ...
            <div className="w-full">
              <div className="h-5 w-24 mt-5 mb-2 rounded-lg bg-neutral-700 animate-pulse"></div>
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 mt-3 p-3">
                <div className="h-80 rounded-lg bg-neutral-800 animate-pulse"></div>
                <div className="h-80 rounded-lg bg-neutral-800 animate-pulse"></div>
                <div className="h-80 rounded-lg bg-neutral-800 animate-pulse"></div>
                <div className="h-80 rounded-lg bg-neutral-800 animate-pulse"></div>
              </div>
