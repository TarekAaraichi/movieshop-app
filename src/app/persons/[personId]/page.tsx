    ...
    <PageWrapper>
      <div className="w-full  mx-auto flex items-start gap-2 p-1 rounded-2xl">
        ...
        <main className="w-full mx-auto flex-grow p-2">
          <section className="flex flex-col gap-6 items-start p-5 rounded-[14px] bg-gradient-to-br from-neutral-900/80 via-neutral-800/60 to-slate-700/50 border border-neutral-700 shadow-2xl backdrop-blur-md">
