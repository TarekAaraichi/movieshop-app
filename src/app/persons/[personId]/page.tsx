    ...
    <PageWrapper>
      <div className="w-full  mx-auto flex items-start gap-2 p-1 rounded-2xl">
        <aside className="shrink-0 p-2">
          <div className="w-64 min-w-66 h-64 rounded-full overflow-hidden shadow-xl relative bg-neutral-900">
            <Image
        ...
        <main className="w-full mx-auto grow p-2">
          <section className="flex flex-col gap-6 items-start p-5 rounded-[14px] bg-linear-to-br from-neutral-900/80 via-neutral-800/60 to-slate-700/50 border border-neutral-700 shadow-2xl backdrop-blur-sm">
            <div className="flex-1 min-w-0">
              <h1 className="text-[32px] font-extrabold m-0 flex items-center gap-3 bg-clip-text text-transparent bg-linear-to-r from-emerald-400 to-blue-400">
                {person.fullName}
                {rolesDisplay ? (
                  <span className="inline-flex items-center rounded-full bg-linear-to-r from-white/40 to-slate-300/30 text-white/80 border border-neutral-700 px-3 py-1 text-xs font-medium">
                    {rolesDisplay}
                  </span>
                ) : null}
              </h1>
