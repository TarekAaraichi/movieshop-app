  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center py-12 px-4">
      <div className="max-w-4xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        {/* Promo / Visual column (hidden on small screens) */}
        <aside className="hidden lg:flex flex-col justify-center rounded-2xl p-8 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 text-white shadow-2xl transform transition-all duration-500 hover:-translate-y-1">
          <div className="mb-6">
            <h2 className="text-3xl font-extrabold tracking-tight">Welcome to MovieShop</h2>
            <p className="mt-3 text-indigo-100/95 max-w-xs">
              Save favorites, get personalized picks, and discover trending films — all in one place.
            </p>
          </div>
          ...
          <ul className="space-y-4">
            ...
            <li className="flex items-center gap-3">
              <span className="inline-flex items-center justify-center w-9 h-9 rounded-lg bg-white/20">
                <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M3 7v4a1 1 0 001 1h3m10 0h3a1 1 0 001-1V7M7 21h10" />
                </svg>
              </span>
              <span className="text-sm font-medium">Save favorites & build lists</span>
            </li>
            ...
            <li className="flex items-center gap-3">
              ...
              <span className="text-sm font-medium">Stay up-to-date with trends</span>
            </li>
          </ul>
          ...
          <div className="bg-white/95 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg border border-gray-200/60 dark:border-gray-800/60">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                  Join MovieShop to save favorites and get personalized recommendations.
                </p>
              </div>
              <div className="hidden sm:flex items-center rounded-full px-3 py-1 text-xs bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200">
                <svg className="w-4 h-4 mr-2 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M12 11c0 2 4 4 4 4m-8 0s4-2 4-4" />
                </svg>
                Free · Secure
              </div>
            </div>
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="flex gap-3">
                ...
                >
                  <svg className="w-4 h-4" viewBox="0 0 533.5 544.3">
                    <path fill="#4285f4" d="M533.5 278.4c0-17.8-1.6-35.1-4.7-51.8H272v98.1h147.2c-6.3 34-25 62.8-53.2 82v68.2h85.9c50.2-46.3 80.6-114.3 80.6-196.5z"/>
                    <path fill="#34a853" d="M272 544.3c72.6 0 133.5-23.9 178-64.9l-85.9-68.2c-23.9 16.1-54.6 25.6-92.1 25.6-70.8 0-130.9-47.8-152.3-112.2H32.3v70.8C76.6 485.8 167.7 544.3 272 544.3z"/>
                    <path fill="#fbbc04" d="M119.7 325.1c-10.6-31.2-10.6-64.9 0-96.1V158.2H32.3c-39 76.7-39 166.9 0 243.6l87.4-76.7z"/>
                    <path fill="#ea4335" d="M272 109.6c39.6 0 75.3 13.6 103.4 40.3l77.5-77.5C405.5 26.7 344.6 3 272 3 167.7 3 76.6 61.5 32.3 158.2l87.4 70.8C141.1 157.4 201.2 109.6 272 109.6z"/>
                  </svg>
                  Google
                </button>
              ...
              <div className="relative text-center my-2">
                ...
                <span className="relative inline-block bg-white dark:bg-gray-900 px-3 text-xs text-gray-500">or</span>
              </div>
                ...
                <a
                  href={
                    searchParams && searchParams.callbackUrl
                      ? `/sign-in?callbackUrl=${encodeURIComponent(String(searchParams.callbackUrl))}`
                      : "/sign-in"
                  }
