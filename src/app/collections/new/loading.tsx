    ...
    <PageWrapper>
      <div className="w-full max-w-6xl mx-auto">
        <header className="mb-8 text-center relative flex flex-col items-center">
          ...
          <div className="h-6 w-1/3 rounded-lg bg-gray-200 dark:bg-neutral-700 animate-pulse"></div>
        </header>
        <div className="space-y-12">
          <div>
            <div className="h-8 w-1/4 mb-6 rounded-lg bg-gray-200 dark:bg-neutral-700 animate-pulse"></div>
