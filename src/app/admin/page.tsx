      ...
      <div className="rounded-3xl bg-transparent">
        <div className="min-h-screen space-y-8 text-zinc-100 p-4 sm:p-6 lg:p-8">
          <header className="max-w-7xl mx-auto">
            <div className="overflow-hidden rounded-3xl border border-zinc-800 bg-[radial-gradient(circle_at_top,_rgba(59,130,246,0.25),_rgba(15,23,42,0.92)_65%)] p-6 sm:p-8 shadow-xl backdrop-blur">
