const CartLoading = () => {
  return (
    <div className="w-full max-w-6xl mx-auto px-4 md:px-0 flex flex-col md:flex-row gap-8 items-start animate-pulse">
      ...
      <main className="flex-1 bg-card dark:bg-neutral-800/50 border border-border dark:border-neutral-800 rounded-2xl shadow-sm p-6 md:p-8">
      ...
      <aside className="w-full md:w-96 sticky top-6 self-start">
        <div className="bg-card dark:bg-neutral-800/50 border border-border dark:border-neutral-800 rounded-2xl shadow-sm p-0 flex flex-col gap-4 overflow-hidden">
          ...
          <div className="pt-3 border-t border-border dark:border-slate-700 px-6 pb-4">
