...
async function main() {
  ...
  const moviesData = [
    {
      ...
      runtime: 148,
      imageUrl:
        "https://image.tmdb.org/t/p/w1280/gqgwNjwjSqGkOqkE2rppogenu4v.jpg", // <-- paste poster URL here
    },
    {
      ...
      runtime: 165,
      imageUrl:
        "https://image.tmdb.org/t/p/w1280/72lbi9vD8ihfeOJTOPnQajVH9DM.jpg",
    },
    {
      title: "Little Women",
      ...
      runtime: 135,
      imageUrl:
        "https://image.tmdb.org/t/p/w1280/hFJo334oFwE3xfclzQvGUiWul1p.jpg",
    },
    {
      title: "Interstellar",
      ...
      runtime: 169,
      imageUrl:
        "https://image.tmdb.org/t/p/w1280/mS4EvhsrT0SQZOlWrQEzWI5KiUa.jpg",
    },
    {
      title: "Get Out",
      ...
      runtime: 104,
      imageUrl:
        "https://image.tmdb.org/t/p/w1280/tFXcEccSQMf3lfhfXKSU9iRBpa3.jpg",
    },
    {
    ...
    },
    {
      ...
      runtime: 139,
      imageUrl:
        "https://image.tmdb.org/t/p/w1280/jSziioSwPVrOy9Yow3XhWIBDjq1.jpg",
    },
    {
      ...
      runtime: 99,
      imageUrl:
        "https://image.tmdb.org/t/p/w1280/gOoCdhFwhVXIAdcWJzbDTorYMpA.jpg",
    },
    {
      title: "Arrival",
      ...
      runtime: 116,
      imageUrl:
        "https://image.tmdb.org/t/p/w1280/pEzNVQfdzYDzVK0XqxERIw2x2se.jpg",
    },
    {
      ...
      runtime: 120,
      imageUrl:
        "https://image.tmdb.org/t/p/w1280/wwhfLPo8sgBFlYmyqRo3Uj2PTZD.jpg",
    },
    {
      title: "La La Land",
    ...
    },
    {
      ...
      runtime: 158,
      imageUrl:
        "https://image.tmdb.org/t/p/w1280/zqDopwg7XQ4IfFX2dRlQCT1SwMG.jpg",
    },
  ];
  ...
  for (let i = 0; i < movies.length; i++) {
    ...
    let actorCount = await prisma.moviePerson.count({
      where: { movieId, role: "ACTOR" },
    });
    ...
    while (actorCount < 2) {
      ...
      const exists = await prisma.moviePerson.findFirst({
        where: { movieId, personId: person.id },
      });
      if (!exists) {
        await prisma.moviePerson.create({
          data: { movieId, personId: person.id, role: "ACTOR" },
        });
        actorCount++;
      }
  ...
  // Demo anonymous user: represents a checkout-only user (no credentials)
  // Note: in production we should only create anonymous users when an order exists.
  await prisma.user.create({
    data: {
