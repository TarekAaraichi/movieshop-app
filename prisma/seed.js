...
/**
 * Seeds movie-related data into the database (movies, genres, people, and their relations).
 *
 * High-level behavior:
 * - Clears only movie-related tables in a single transaction to make the seed idempotent
 *   for movie data. The deletion order is chosen to avoid foreign-key constraint failures:
 *   cartItem, orderItem, moviePerson, movieGenre, movie, genre, person.
 * - Builds a set of movie records (title, releaseDate, price, stock, runtime, imageUrl, genre,
 *   director, actors, bio) and a personData map with bios and placeholder image URLs for people.
 * - Upserts genres and people (directors and actors) so repeated runs do not create duplicates.
 *   Uses two in-memory maps (genreMap and personMap) to cache created/upserted records.
 * - Creates movies and links them to genres via movieGenre records, and to people via
 *   moviePerson records, assigning roles ("DIRECTOR" / "ACTOR").
 * - Logs the number of movies inserted and a small sample of movie ids/titles.
 *
 * Important notes for collaborators:
 * - The script intentionally does not touch user/account-related tables ("no users/accounts")
 *   so it can be safely rerun during development without affecting authentication data.
 * - The seed uses prisma client methods (prisma.genre.upsert, prisma.person.upsert,
 *   prisma.movie.create, prisma.movieGenre.create, prisma.moviePerson.create, etc.). Ensure
 *   a valid `prisma` client is in scope before invoking this function.
 * - If the initial cleanup transaction fails, the error is logged and rethrown so failures
 *   are visible rather than silently ignored.
 * - Person image URLs and some metadata are placeholders and can be refined later.
 *
 * Usage:
 * - Intended to be run in a Node.js environment with Prisma configured (e.g. `node prisma/seed.js`
 *   or via a package script). It returns a Promise and should be awaited or handled as part
 *   of an async process.
 *
 * @async
 * @function main
 * @returns {Promise<void>} Resolves when seeding completes successfully.
 * @throws {Error} Rethrows errors encountered during cleanup or data creation so the runner
...
async function main() {
  ...
  try {
    ...
    console.error("Error clearing movie-related tables:", err);
    // Continue — we don't want seeding to silently succeed if cleanup failed.
    throw err;
  }
  ...
  const movies = [
    ...
    },
    {
      ...
      runtime: 165,
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/7oWY8VDWW7thTzWh3OKYRkWUlD5.jpg",
      genre: "Drama",
    ...
    },
    {
      ...
      runtime: 135,
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/yn5ihODtZ7ofn8pDYfxCmxh8AXI.jpg",
      genre: "Romance",
    ...
    },
    {
      ...
      runtime: 169,
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/gEU2QniE6E77NI6lCU6MxlNBvIx.jpg",
      genre: "Sci-Fi",
      director: "Christopher Nolan",
    ...
    },
    {
      ...
      runtime: 104,
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/tFXcEccSQMf3lfhfXKSU9iRBpa3.jpg",
      genre: "Horror",
    ...
    },
    {
      ...
      runtime: 164,
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/gajva2L0rPYkEWjzgFlBXCAVBE5.jpg",
      genre: "Sci-Fi",
    ...
    },
    {
      ...
      runtime: 139,
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/jSziioSwPVrOy9Yow3XhWIBDjq1.jpg",
      genre: "Drama",
    ...
    },
    {
      ...
      runtime: 99,
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/eWdyYQreja6JGCzqHWXpWHDrrPo.jpg",
      genre: "Comedy",
    ...
    },
    {
      ...
      runtime: 116,
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/x2FJsf1ElAgr63Y3PNPtJrcmpoe.jpg",
      genre: "Sci-Fi",
      director: "Denis Villeneuve",
    ...
    },
    {
      ...
      runtime: 120,
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/n0ybibhJtQ5icDqTp8eRytcIHJx.jpg",
      genre: "Drama",
      director: "David Fincher",
    ...
    },
    {
      ...
      runtime: 156,
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/ji3ecJphATlVgWNY0B0RVXZizdf.jpg",
      genre: "Action",
    ...
    },
    {
      ...
      runtime: 108,
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/1mqL7VG4Ix8wmxwypmCA1HTHBky.jpg",
      genre: "Comedy",
    ...
    },
    {
      ...
      runtime: 141,
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/v4ncgZjG2Zu8ZW5al1vIZTsSjqX.jpg",
      genre: "Action",
    ...
    },
    {
      ...
      runtime: 158,
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/8bokS83zGdhaXgN9tjidUKmAftW.jpg",
      genre: "Thriller",
      director: "David Fincher",
  ...
  // person bios and placeholder imageUrl
  const personData = {
    "Christopher Nolan": {
    ...
    "Quentin Tarantino": {
      ...
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/1gjcpAa99FAOWGnrUvHEXXsRs7o.jpg",
    },
    "Greta Gerwig": {
      bio: "American writer-director and actress known for intimate literary adaptations and strong character work.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/6MwQ2GstYr0wnhp1eTOAbVMNBGN.jpg",
    },
    "Denis Villeneuve": {
      bio: "Canadian director acclaimed for atmospheric visuals and thoughtful science-fiction.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/zdDx9Xs93UIrJFWYApYR28J8M6b.jpg",
    },
    "Jordan Peele": {
      bio: "American writer-director who blends social commentary with genre horror and dark satire.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/kFUKn5g3ebpyZ3CSZZZo2HFWRNQ.jpg",
    },
    "David Fincher": {
      bio: "American director known for meticulous, moody thrillers and precise visual style.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/tpEczFclQZeKAiCeKZZ0adRvtfz.jpg",
    },
    "Wes Anderson": {
      bio: "American director celebrated for whimsical visuals, symmetry and ensemble casts.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/s03CeUeC5yAXyB1acqP0zGNo2SC.jpg",
    },
    "Damien Chazelle": {
      bio: "American director known for music-driven films and energetic storytelling.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/14kRZ3XxNMyBv717YQSXr3wCucy.jpg",
    },
    "Alejandro González Iñárritu": {
      bio: "Mexican director noted for immersive, emotionally intense films and innovative technique.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/Av0jewh8wltCl1CB8MfEIrvgfMZ.jpg",
    },
    "Taika Waititi": {
      bio: "New Zealand director and writer blending irreverent humor with heartfelt storytelling.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/aH6MgwFhomAPNBRPyO2fhpU5kbk.jpg",
    },
    "Patty Jenkins": {
      bio: "American director known for character-focused blockbuster filmmaking and strong female leads.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/za4JYxjctECHLJJel3lEFPsbeht.jpg",
    },

    "Leonardo DiCaprio": {
      bio: "American actor known for committed performances across dramatic and blockbuster roles.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/wo2hJpn04vbtmh0B9utCFdsQhxM.jpg",
    },
    ...
    "Jamie Foxx": {
      ...
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/zD8Nsy4Xrghp7WunwpCj5JKBPeU.jpg",
    },
    "Christoph Waltz": {
      bio: "Austrian actor known for multilingual, nuanced performances and dark humor.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/jMvLGCVXLaBqjRLf5olyvEucZob.jpg",
    },
    "Saoirse Ronan": {
      bio: "Irish actress celebrated for remarkable emotional range from a young age.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/9buDPdqKN9vbnQLLkHEinDtMrCG.jpg",
    },
    "Emma Watson": {
    ...
    "Florence Pugh": {
      ...
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/6Sjz9teWjrMY9lF2o9FCo4XmoRh.jpg",
    },
    "Matthew McConaughey": {
    ...
    "Jessica Chastain": {
      ...
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/xRvRzxiiHhgUErl0yf9w8WariRE.jpg",
    },
    "Daniel Kaluuya": {
      bio: "British actor acclaimed for emotionally charged, powerful screen performances.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/jj2kZqJobjom36wlhlYhc38nTwN.jpg",
    },
    "Allison Williams": {
      bio: "American actress known for both comedic and dramatic roles across film and TV.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/5Jy9HELKS1OYg7moRl8870OSfJq.jpg",
    },
    "Catherine Keener": {
      bio: "Veteran American character actress known for grounded supporting performances.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/n4CTwGszs6cwS1wJRlDQ5Mlh7Ex.jpg",
    },
    "Ryan Gosling": {
      bio: "Canadian actor and musician praised for range from indie drama to mainstream romance.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/asoKC7CLCqpZKZDL6iovNurQUdf.jpg",
    },
    "Harrison Ford": {
      bio: "Iconic American actor known for adventure heroes and enduring leading roles.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/zVnHagUvXkR2StdOtquEwsiwSVt.jpg",
    },
    "Ana de Armas": {
      bio: "Cuban-Spanish actress rising rapidly for charismatic, contemporary performances.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/5Qne374OM0ewMM7uSN9eq9jNrWq.jpg",
    },
    "Brad Pitt": {
      bio: "American actor and producer with a diverse career spanning dramatic and commercial hits.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/9OfnD7lxgIj3BNQpJFnwxnwl6w5.jpg",
    },
    "Edward Norton": {
      bio: "American actor known for intense, character-driven performances and producing work.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/8nytsqL59SFJTVYVrN72k6qkGgJ.jpg",
    },
    "Helena Bonham Carter": {
      bio: "English actress known for eccentric, memorable roles across period and modern work.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/hJMbNSPJ2PCahsP3rNEU39C8GWU.jpg",
    },
    "Ralph Fiennes": {
      bio: "English actor and director noted for powerful stage and screen work.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/u29BOqiV5GCQ8k8WUJM50i9xlBf.jpg",
    },
    "Tony Revolori": {
      bio: "American actor recognized for precise comedic timing and supporting turns.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/tSF6XmXDikrKZbFUeoDnafXxKjT.jpg",
    },
    "Amy Adams": {
      bio: "American actress acclaimed for her wide emotional range and dramatic depth.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/lub0nBRhsCu2pByvfvxt5DcW86d.jpg",
    },
    "Jeremy Renner": {
    ...
    "Forest Whitaker": {
      ...
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/4w7l5JUwnwFNBy7J93ZwYN1nihm.jpg",
    },
    "Jesse Eisenberg": {
      bio: "American actor and writer known for neurotic, intellectually charged characters.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/8BMnXLVJDysMO1E8JCAyOFv2QAb.jpg",
    },
    "Andrew Garfield": {
      bio: "British-American actor recognized for emotionally honest and physical performances.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/5ydZ6TluPtxlz5G8nlWMB7SGmow.jpg",
    },
    "Justin Timberlake": {
      bio: "American singer-actor known for pop stardom and branching into film roles.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/6Yk5t9RwkdkAT8Qv45934Eez2CA.jpg",
    },
    "Emma Stone": {
      bio: "American actress noted for charm, range and strong comedic instincts.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/bKbFmFQtn1N6Utzr9Sf0E23alaL.jpg",
    },
    "John Legend": {
      bio: "American singer-songwriter and actor with acclaimed musical and film credits.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/5HUGMf3Lf88IisKr2Av3kSdVoLL.jpg",
    },
    "Will Poulter": {
      bio: "English actor noted for eccentric and memorable supporting performances.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/1zQLes0vhspVA6WqYEFQEvRr4xH.jpg",
    },
    "Roman Griffin Davis": {
    ...
    "Thomasin McKenzie": {
      ...
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/of8zI5FA5cNBbZK8KdgTSw0znXK.jpg",
    },
    "Scarlett Johansson": {
      bio: "American actress and singer known for wide-ranging roles in indie and blockbuster films.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/8m21eocprLYuW0ywveIgThk6VM.jpg",
    },
    "Gal Gadot": {
      bio: "Israeli actress and model known internationally for her role as a superhero lead.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/qCJB1ACi5VjtY4ypXuv3hjAvbSu.jpg",
    },
    "Chris Pine": {
      bio: "American actor recognized for charismatic leading performances in action and drama.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/d8hGMH1igEFnpNFEEFdP3yFHV3U.jpg",
    },
    "Robin Wright": {
      bio: "American actress and director known for subtle, powerful character work.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/d3rIv0y2p0jMsQ7ViR7O1606NZa.jpg",
    },
    "Rooney Mara": {
      bio: "American actress known for intense, haunting performances in dramatic roles.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/zT6UyHFHEQ9RcKykplWCycKBnoS.jpg",
    },
    "Daniel Craig": {
      bio: "English actor best known for redefining a major action franchise with gritty realism.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/iFerDZUmC5Fu26i4qI8xnUVEHc7.jpg",
    },
    "Stellan Skarsgård": {
      bio: "Swedish actor noted for versatile, character-driven work across international films.",
      imageUrl:
        "https://media.themoviedb.org/t/p/w600_and_h900_bestv2/x78BtYHElirO7Iw8bL4m8CnzRDc.jpg",
    },
  };
  ...
  for (const m of movies) {
    ...
    // attach single genre
    if (m.genre) {
      const genre = genreMap.get(m.genre);
      if (genre) {
